        ...
        <main class="main-wrapper clearfix">
            ...
            <div class="row page-title clearfix">
                <div class="page-title-left">
                    <h6 class="page-title-heading mr-0 mr-r-5">CREDIT CARD CHECKER</h6>
                ...
                <div class="widget-holder widget-full-height widget-flex col-lg-6">
                    <div class="widget-bg">
                        <div class="widget-heading">
                            <h5 class="widget-title"><span class="badge badge-success"> PAYMAYA </span></h5>
                        ...
                        <div class="widget-body">
                            <button type="button" id="sh_apr" onclick="Mudaestado('aprovadasapp');" class="btn btn-success">APROVADAS [ <span id="aprovada_conta">0</span> ]</button>
                            ...
                            <button type="button" id="sh_rep" onclick="Mudaestado('reprovadasapp');" class="btn btn-danger">REPROVADAS [ <span id="reprovada_conta">0</span> ]</button>
                        ...
                        <div class="widget-body">
                            <div class="container-fluid pd-20">
                                <div class="row">
                                    ...
                                    APROVADAS: <span id="CLIVE" class="badge badge-success">0</span> - 
                                    REPROVADAS: <span id="CDIE" class="badge badge-danger">0</span> - 
                                    TESTED: <span id="testado" class="badge badge-warning">0</span> - 
                                    TOTAL: <span id="carregada" class="badge badge-facebook">0</span></small>
                                    </small>
                                    <br><br>

                                    Date: <span class="badge badge-primary" id="horas">NULL</span><br><br>

                                    EDITED BY :  <span class="badge badge-warning"> PAYMAYA</span>
